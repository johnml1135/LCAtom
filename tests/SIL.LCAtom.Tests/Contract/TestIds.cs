...
{
    public const string ChangeSet1 = "agent_AAECAwQFBgcICQoLDA0ODw"; // bytes 0x00..0x0f (doc's own example)
    public const string ChangeSet2 = "agent_EBESExQVFhcYGRobHB0eHw"; // bytes 0x10..0x1f
