...
The answer must not recreate Motif's withdrawn runner. ADR 0013 makes Harmony's
`IChange`/`Commit` the change mechanism and reserves Motif for research,
...
| `Motif` | `8fa1e5ec4d0183020de2554e5254356e0e4d77bc` | README product boundary excludes UI, review queues, approval, hosting and storage; ADR 0013 withdraws the competing contract/runner. | Owns this research and the coverage/contract findings only; it is not the companion product's home. |
...
| Motif coverage inventory, migration decisions, independent evidence and architecture ADRs | Motif | Motif | That is the repository's surviving role after ADR 0013. | It should not own new runtime state, CLI delivery, UI, or a rival semantic change pipeline. |
...
| Motif | It contains prior CLI/semantic change work and the current research. | ADR 0013 rejects restoring a competing runner, and Motif explicitly excludes UI, review, hosting and storage. |
...
Motif: cross-repository research, decisions and coverage evidence
```
