...
/// <c>operations</c> array. This is distinct from the Proposal-level <c>requires</c>
/// (docs/change-set-contract.md, "Prerequisites"), which names other Proposals that must already
