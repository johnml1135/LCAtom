...
/// placement primitive belongs alongside per-field kinds is still open (<c>J45</c>) — deciding that
/// architectural question is not this slice's job. <c>addRef</c>/<c>removeRef</c> are unaffected: they
