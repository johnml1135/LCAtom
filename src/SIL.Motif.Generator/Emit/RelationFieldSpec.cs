...
/// <summary>
/// Every derived fact the <c>rel/atomic</c> <c>set|clear</c> templates need for one field,
...
/// <summary>
/// Every derived fact the <c>addRef|removeRef</c> templates need for one <c>rel/col</c> or
