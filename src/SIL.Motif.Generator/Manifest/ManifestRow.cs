...
/// <summary>
/// One row of <c>manifest/liblcm-inventory.tsv</c>, all 18 columns (the manifest README). Values stay
...
/// (<c>Derivation/GroupDerivation.cs</c>). The TSV file itself is read-only (the manifest README) and
