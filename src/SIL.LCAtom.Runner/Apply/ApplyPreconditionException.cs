...
/// <summary>
/// Thrown by <see cref="ChangeSetApplier.Apply"/> when its ADR-0004-§3 precondition is not met: no
/// <c>BoundAssessmentAnchor</c> was supplied at all (a bare apply — a hard error), or one was
