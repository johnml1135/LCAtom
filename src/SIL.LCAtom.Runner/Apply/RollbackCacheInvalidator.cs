...
/// <see cref="SIL.LCAtom.Runner.Apply.ChangeSetApplier.Apply"/> both consult before doing any further
...
/// will need it (see also <see cref="SIL.LCAtom.Runner.Assessment.DerivedCachePoisoningOperationKinds"/>,
/// which wires the equivalent guard into Assess).
/// </para>
/// </remarks>
