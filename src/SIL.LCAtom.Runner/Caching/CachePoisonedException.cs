...
/// <summary>
/// Thrown by <see cref="CacheReusability.EnsureReusable"/> when a caller attempts to Assess or Apply
...
/// discard and reload the project (a fresh <see cref="LcmCache"/> instance) before assessing or
/// applying again.
/// </summary>
public sealed class CachePoisonedException : InvalidOperationException
{
    public CachePoisonedException(LcmCache cache, string reason)
        : base(
            "This LcmCache instance is no longer safe to reuse for Assess/Apply: " + reason +
