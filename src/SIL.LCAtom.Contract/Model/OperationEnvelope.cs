...
/// <summary>
/// One operation inside a Change Set's authoritative <c>operations</c> array. See
...
public sealed record OperationEnvelope
{
    ...
    /// <summary>Unique (within this Change Set) canonical id for this operation.</summary>
