...
/// <summary>
/// Computes the Change Set intent digest: RFC 8785 canonical JSON bytes over the intent
...
{
    /// <summary>The RFC 8785 canonical UTF-8 bytes of the Change Set's intent projection.</summary>
    public static byte[] CanonicalBytes(ChangeSetEnvelope changeSet)
    {
        var projectionJson = IntentProjectionWriter.WriteProjectionJson(changeSet);
    ...
    public static string Compute(ChangeSetEnvelope changeSet) => Sha256Of(CanonicalBytes(changeSet));
