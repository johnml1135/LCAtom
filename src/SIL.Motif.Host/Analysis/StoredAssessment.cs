...
/// </summary>
/// <remarks>
/// Mirrors <see cref="GrammarCoverageFigure.Compute(BatchAnalysis, Selection, string)"/>'s same
...
/// set's identity (<see cref="Selection.Sha256"/>) together, and this is where a caller who already
...
/// </remarks>
public sealed record StoredAssessment(AssessReport Report, Selection Selection);
