...
namespace SIL.LCAtom.Model.Receipts;

/// <summary>
/// The result of <c>ChangeSetApplier.Apply</c>: a minimal slice of the full Application Receipt
...
/// </summary>
/// <param name="ChangeSetId">The Change Set's stable, frozen id (see "Change Set identity vs content digest").</param>
/// <param name="IntentDigest">
/// The full <c>sha256:</c>-prefixed intent digest of the Change Set actually presented to this
...
/// <c>true</c> when <see cref="ChangeSetId"/> was already present in the applied-change log: Apply
...
/// including a content-check note if the supplied Change Set's intent digest differs from the one
...
/// distinct from an Assessment's expected effects. Empty when <see cref="AlreadyApplied"/>, because
...
/// The applied-change-log entry this Change Set is recorded under: the one just written (a fresh
